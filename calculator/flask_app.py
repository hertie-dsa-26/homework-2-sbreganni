...
def circle():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            return render_template('circle.html', print_perimeter=perimeter, print_area=area)
        
        except ValueError:
            perimeter="Cannot perform operation with this input", 
            area="Cannot perform operation with this input"
